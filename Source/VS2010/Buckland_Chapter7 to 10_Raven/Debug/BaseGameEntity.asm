; Listing generated by Microsoft (R) Optimizing Compiler Version 19.42.34435.0 
	...
	TITLE	C:\Users\rpg26\OneDrive\Desktop\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\BaseGameEntity.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG165846 DB	'invalid argument', 00H
	ORG $+3
$SG165847 DB	'%s', 00H
	ORG $+1
$SG165848 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.42.34433\include\xmemory', 00H
	ORG $+6
$SG165849 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
...
$SG165850 DB	00H, 00H
	ORG $+2
$SG165851 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?_Valid_strftime_specifiers@std@@3QBDB DB 061H		; std::_Valid_strftime_specifiers
	...
	DB	07aH
	DB	05aH
$SG161169 DB	'<BaseGameEntity::SetID>: invalid ID', 00H
$SG161170 DB	'C', 00H, ':', 00H, '\', 00H, 'U', 00H, 's', 00H, 'e', 00H
	...
	DB	'B', 00H, 'a', 00H, 's', 00H, 'e', 00H, 'G', 00H, 'a', 00H, 'm'
	DB	00H, 'e', 00H, 'E', 00H, 'n', 00H, 't', 00H, 'i', 00H, 't', 00H
	DB	'y', 00H, '.', 00H, 'c', 00H, 'p', 00H, 'p', 00H, 00H, 00H
	ORG $+6
$SG161171 DB	'(', 00H, 'v', 00H, 'a', 00H, 'l', 00H, ' ', 00H, '>', 00H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\Source\VS2010\Common\Game\BaseGameEntity.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_ID$ = 8						; size = 4
