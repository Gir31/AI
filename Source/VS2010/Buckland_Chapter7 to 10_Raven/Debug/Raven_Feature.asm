...
?piecewise_construct@std@@3Upiecewise_construct_t@1@B	ORG $+1 ; std::piecewise_construct
	ORG $+3
$SG214167 DB	'RailGun_MaxRoundsCarried', 00H
	ORG $+3
$SG214169 DB	'RocketLauncher_MaxRoundsCarried', 00H
$SG214171 DB	'ShotGun_MaxRoundsCarried', 00H
	ORG $+3
$SG214174 DB	'trying to calculate  of unknown weapon', 00H
	ORG $+1
$SG225030 DB	'invalid argument', 00H
	ORG $+3
$SG225031 DB	'%s', 00H
	ORG $+5
$SG225032 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.44.35207\include\xmemory', 00H
	ORG $+6
$SG225733 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
; 114  :     // 1. 가장 최근 감지된 위치를 가져옵니다.
; 115  :     const Vector2D LastPos = pBot->GetSensoryMem()->GetMostRecentlySensedPosition();
...
; 116  : 
; 117  :     // 2. 현재 위치와의 거리를 계산합니다.
; 118  :     double Dist = Vec2DDistance(pBot->Pos(), LastPos);
...
; 119  : 
; 120  :     // 3. 점수 계산을 위한 범위 설정 (예: 500 unit 이상이면 0점)
; 121  :     const double MaxDistance = 500.0;

	movsd	xmm0, QWORD PTR __real@407f400000000000
	movsd	QWORD PTR _MaxDistance$[ebp], xmm0

; 122  : 
; 123  :     // 4. 거리가 0이면(즉, 정보가 없거나 바로 그 위치라면) 1 반환
; 124  :     //    거리가 MaxDistance 이상이면 0 반환
; 125  :     if (Dist > MaxDistance) return 0.0;
...
; 126  : 
; 127  :     // 5. 선형 보간: 거리가 가까울수록 1에 가깝게
; 128  :     return 1.0 - (Dist / MaxDistance);

	movsd	xmm0, QWORD PTR _Dist$[ebp]
	divsd	xmm0, QWORD PTR __real@407f400000000000
	movsd	xmm1, QWORD PTR __real@3ff0000000000000
	subsd	xmm1, xmm0
	movsd	QWORD PTR tv94[ebp], xmm1
...
; 129  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN6@ClosenessT
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
