...
_BSS	ENDS
CONST	SEGMENT
$SG213400 DB	'invalid argument', 00H
?piecewise_construct@std@@3Upiecewise_construct_t@1@B	ORG $+1 ; std::piecewise_construct
	ORG $+2
$SG213401 DB	'%s', 00H
	ORG $+1
$SG213402 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.44.35207\include\xmemory', 00H
	ORG $+6
$SG214045 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
?_Valid_strftime_specifiers@std@@3QBDB DB 061H		; std::_Valid_strftime_specifiers
	...
	DB	05aH
	ORG $+4
$SG203779 DB	'< Raven_SensoryMemory::GetLastRecordedPositionOfOpponent'
...
; 190  :     _STL_VERIFY(_Ptr_container != 0, "invalid argument"); // validate even in release since we're doing p[-1]
	...
	push	OFFSET $SG213400
	push	OFFSET $SG213401
	push	0
	push	190					; 000000beH
	push	OFFSET $SG213402
	push	2
	call	__CrtDbgReport
