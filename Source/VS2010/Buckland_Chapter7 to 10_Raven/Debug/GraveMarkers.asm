; Listing generated by Microsoft (R) Optimizing Compiler Version 19.42.34435.0 
	...
	TITLE	C:\Users\rpg26\OneDrive\Desktop\ÇÐ±³\AI\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\GraveMarkers.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?_Valid_strftime_specifiers@std@@3QBDB DB 061H		; std::_Valid_strftime_specifiers
	...
	DB	07aH
	DB	05aH
$SG168079 DB	'invalid argument', 00H
	ORG $+3
$SG168080 DB	'%s', 00H
	ORG $+5
$SG168081 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.42.34433\include\xmemory', 00H
	ORG $+6
$SG168082 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
...
$SG168083 DB	00H, 00H
	ORG $+2
$SG168084 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN12@Allocate_m:
	push	0
	push	159					; 0000009fH
	push	OFFSET $SG168082
	push	OFFSET $SG168083
	push	OFFSET $SG168084
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\ÇÐ±³\AI\AI\Source\VS2010\Common\2D\Transformations.h
...
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\ÇÐ±³\AI\AI\Source\VS2010\Common\2D\C2DMatrix.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\ÇÐ±³\AI\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\GraveMarkers.cpp
_TEXT	SEGMENT
$T1 = -28						; size = 24
_this$ = -4						; size = 4
_pos$ = 8						; size = 16
...
; 1412 :     iterator erase(const const_iterator _Where) noexcept /* strengthened */ {
...
; 1414 :         _STL_VERIFY(_Where._Getcont() == _STD addressof(_Mypair._Myval2), "list erase iterator outside range");
...
; 1415 : #endif // _ITERATOR_DEBUG_LEVEL == 2
; 1416 :         const auto _Result = _Where._Ptr->_Next;

	mov	ecx, DWORD PTR __Where$[ebp+8]
	mov	edx, DWORD PTR [ecx]
	mov	DWORD PTR __Result$[ebp], edx

; 1417 :         _Node::_Freenode(_Getal(), _Mypair._Myval2._Unlinknode(_Where._Ptr));
...
; 1418 :         return _Make_iter(_Result);
...
; 412  :     _CONSTEXPR20 void _Take_contents(_Vector_val& _Right) noexcept {
...
; 413  :         this->_Swap_proxy_and_iterators(_Right);
...
; 417  : 
; 418  :         _Right._Myfirst = nullptr;

	mov	ecx, DWORD PTR __Right$[ebp]
	mov	DWORD PTR [ecx+4], 0

; 419  :         _Right._Mylast  = nullptr;

	mov	edx, DWORD PTR __Right$[ebp]
	mov	DWORD PTR [edx+8], 0

; 420  :         _Right._Myend   = nullptr;
...
; 730  :         _Choose_pocma_v<_Alty> != _Pocma_values::_No_propagate_allocators) {
...
; 731  :         if (this == _STD addressof(_Right)) {
...
; 733  :         }
; 734  : 
; 735  :         _Alty& _Al                = _Getal();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Getal@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@AAEAAV?$allocator@UVector2D@@@2@XZ ; std::vector<Vector2D,std::allocator<Vector2D> >::_Getal
	mov	DWORD PTR __Al$[ebp], eax

; 736  :         _Alty& _Right_al          = _Right._Getal();

	mov	ecx, DWORD PTR __Right$[ebp]
	call	?_Getal@?$vector@UVector2D@@V?$allocator@UVector2D@@@std@@@std@@AAEAAV?$allocator@UVector2D@@@2@XZ ; std::vector<Vector2D,std::allocator<Vector2D> >::_Getal
	mov	DWORD PTR __Right_al$[ebp], eax

; 737  :         constexpr auto _Pocma_val = _Choose_pocma_v<_Alty>;

	mov	DWORD PTR __Pocma_val$[ebp], 0

; 738  :         if constexpr (_Pocma_val == _Pocma_values::_No_propagate_allocators) {
; 739  :             if (_Al != _Right_al) {
; 740  :                 _Move_assign_unequal_alloc(_Right);
; 741  :                 return *this;
; 742  :             }
; 743  :         }
; 744  : 
...
; 746  : #if _ITERATOR_DEBUG_LEVEL != 0
; 747  :         if constexpr (_Pocma_val == _Pocma_values::_Propagate_allocators) {
; 748  :             if (_Al != _Right_al) {
; 749  :                 // intentionally slams into noexcept on OOM, TRANSITION, VSO-466800
; 750  :                 _Mypair._Myval2._Reload_proxy(_GET_PROXY_ALLOCATOR(_Alty, _Al), _GET_PROXY_ALLOCATOR(_Alty, _Right_al));
; 751  :             }
; 752  :         }
; 753  : #endif // _ITERATOR_DEBUG_LEVEL != 0
; 754  : 
; 755  :         _Pocma(_Al, _Right_al);
...
; 756  :         _Mypair._Myval2._Take_contents(_Right._Mypair._Myval2);
...
; 680  :         _Construct_n(_Count, _Right_data._Myfirst, _Right_data._Mylast);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\ÇÐ±³\AI\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\GraveMarkers.h
