...
_BSS	ENDS
CONST	SEGMENT
$SG206469 DB	'invalid argument', 00H
	ORG $+3
$SG206470 DB	'%s', 00H
	ORG $+1
$SG206471 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
EXTRN	?DismissMostRecentSound@Raven_SensoryMemory@@QAEXXZ:PROC ; Raven_SensoryMemory::DismissMostRecentSound
...
; 190  :     _STL_VERIFY(_Ptr_container != 0, "invalid argument"); // validate even in release since we're doing p[-1]
	...
	push	OFFSET $SG206469
	push	OFFSET $SG206470
	push	0
	push	190					; 000000beH
	push	OFFSET $SG206471
	push	2
	call	__CrtDbgReport
...
; 34   : 
; 35   :     if (SubgoalStatus == completed)

	cmp	DWORD PTR _SubgoalStatus$[ebp], 2
	jne	SHORT $LN2@Process

; 36   :     {
; 37   :         m_pOwner->GetSensoryMem()->DismissMostRecentSound();

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	call	?GetSensoryMem@Raven_Bot@@QBEQAVRaven_SensoryMemory@@XZ ; Raven_Bot::GetSensoryMem
	mov	ecx, eax
	call	?DismissMostRecentSound@Raven_SensoryMemory@@QAEXXZ ; Raven_SensoryMemory::DismissMostRecentSound

; 38   : 
; 39   :         m_iStatus = completed;
...
; 41   :     else if (SubgoalStatus == failed)
...
; 21   :     }
; 22   : 
; 23   :     AddSubgoal(new Goal_MoveToPosition(m_pOwner, noisePos));
