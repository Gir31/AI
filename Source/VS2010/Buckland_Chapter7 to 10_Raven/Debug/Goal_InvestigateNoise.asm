; Listing generated by Microsoft (R) Optimizing Compiler Version 19.42.34435.0 
	...
	TITLE	C:\Users\rpg26\OneDrive\Desktop\학교\AI\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\Goal_InvestigateNoise.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG172305 DB	'invalid argument', 00H
	ORG $+3
$SG172306 DB	'%s', 00H
	ORG $+1
$SG172307 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.42.34433\include\xmemory', 00H
	ORG $+6
$SG172308 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
...
$SG172309 DB	00H, 00H
	ORG $+2
$SG172310 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
PUBLIC	?Activate@Goal_InvestigateNoise@@UAEXXZ		; Goal_InvestigateNoise::Activate
PUBLIC	?Process@Goal_InvestigateNoise@@UAEHXZ		; Goal_InvestigateNoise::Process
...
_volmd	DD	0ffffffffH
	DDSymXIndex: 	FLAT:__unwindfunclet$?Activate@Goal_InvestigateNoise@@UAEXXZ$0
	DD	01dH
voltbl	ENDS
xdata$x	SEGMENT
__unwindtable$?Activate@Goal_InvestigateNoise@@UAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_InvestigateNoise@@UAEXXZ$0
__ehfuncinfo$?Activate@Goal_InvestigateNoise@@UAEXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?Activate@Goal_InvestigateNoise@@UAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\학교\AI\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\goals\Goal_MoveToPosition.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\학교\AI\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\goals\Goal_InvestigateNoise.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Process@Goal_InvestigateNoise@@UAEHXZ PROC		; Goal_InvestigateNoise::Process
; _this$ = ecx
...
; 36   :     // 만약 비활성 상태라면 Activate()를 호출해 시작합니다.
...
; 38   : 
; 39   :     // 하위 목표(Goal_MoveToPosition)를 실행하고 상태를 받아옵니다.
; 40   :     m_iStatus = ProcessSubgoals();
...
; 41   : 
; 42   :     // 만약 이동이 끝났다면(completed) 혹은 실패했다면(failed),
; 43   :     // 이 InvestigateNoise 목표도 그에 맞춰 종료됩니다.
; 44   :     return m_iStatus;
...
; 45   : }
	...
	pop	ebp
	ret	0
?Process@Goal_InvestigateNoise@@UAEHXZ ENDP		; Goal_InvestigateNoise::Process
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\학교\AI\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\goals\Goal_InvestigateNoise.cpp
_TEXT	SEGMENT
...
$T3 = -60						; size = 4
$T4 = -56						; size = 16
_noisePos$ = -36					; size = 16
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?Activate@Goal_InvestigateNoise@@UAEXXZ PROC		; Goal_InvestigateNoise::Activate
; _this$ = ecx
...
; 10   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Activate@Goal_InvestigateNoise@@UAEXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 12   : 
; 13   :     // 기존에 남아있던 하위 목표들을 깨끗이 비웁니다.
; 14   :     RemoveAllSubgoals();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?RemoveAllSubgoals@?$Goal_Composite@VRaven_Bot@@@@QAEXXZ ; Goal_Composite<Raven_Bot>::RemoveAllSubgoals

; 15   : 
; 16   :     // 1. 감각 기억 시스템(SensoryMemory)에서 가장 최근 소리가 났던 위치를 가져옵니다.
; 17   :     Vector2D noisePos = m_pOwner->GetSensoryMem()->GetMostRecentlySensedPosition();
...
; 18   : 
; 19   :     // (방어 코드) 만약 위치가 유효하지 않다면(예: 봇의 현재 위치와 동일), 목표를 즉시 완료 처리합니다.
; 20   :     if (noisePos == m_pOwner->Pos())
...
; 24   :     }
; 25   : 
; 26   :     // 2. 해당 위치로 이동하는 하위 목표(Goal_MoveToPosition)를 추가합니다.
; 27   :     //    Goal_MoveToPosition은 길 찾기(Pathfinding)까지 알아서 처리해줍니다.
; 28   :     AddSubgoal(new Goal_MoveToPosition(m_pOwner, noisePos));
	...
	mov	ecx, esp
	mov	edx, DWORD PTR _noisePos$[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _noisePos$[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _noisePos$[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _noisePos$[ebp+12]
	mov	DWORD PTR [ecx+12], eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 29   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN10@Activate
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?Activate@Goal_InvestigateNoise@@UAEXXZ$0:
	push	48					; 00000030H
	...
	int	3
	int	3
__ehhandler$?Activate@Goal_InvestigateNoise@@UAEXXZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?Activate@Goal_InvestigateNoise@@UAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?Activate@Goal_InvestigateNoise@@UAEXXZ ENDP		; Goal_InvestigateNoise::Activate
; Function compile flags: /Odtp /RTCsu
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\학교\AI\AI\Source\VS2010\Common\Goals\Goal_Composite.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\학교\AI\AI\Source\VS2010\Common\Goals\Goal.h
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\학교\AI\AI\Source\VS2010\Common\misc\cgdi.h
