; Listing generated by Microsoft (R) Optimizing Compiler Version 19.44.35221.0 
	...
	TITLE	C:\Users\82102\Desktop\학교\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\Raven_Goal_Types.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG59790 DB	'explore', 00H
$SG59792 DB	'think', 00H
	ORG $+2
$SG59794 DB	'arrive_at_position', 00H
	ORG $+1
$SG59796 DB	'seek_to_position', 00H
	ORG $+3
$SG59798 DB	'follow_path', 00H
$SG59800 DB	'traverse_edge', 00H
	ORG $+2
$SG59802 DB	'move_to_position', 00H
	ORG $+3
$SG59804 DB	'get_health', 00H
	ORG $+1
$SG59806 DB	'get_shotgun', 00H
$SG59808 DB	'get_railgun', 00H
$SG59810 DB	'get_rocket_launcher', 00H
$SG59812 DB	'wander', 00H
	ORG $+1
$SG59814 DB	'negotiate_door', 00H
	ORG $+1
$SG59816 DB	'attack_target', 00H
	ORG $+2
$SG59818 DB	'hunt_target', 00H
$SG59820 DB	'strafe', 00H
	ORG $+1
$SG59822 DB	'adjust_range', 00H
	ORG $+3
$SG59824 DB	'say_phrase', 00H
	ORG $+1
$SG59826 DB	'investigate_noise', 00H
	ORG $+2
$SG59828 DB	'UNKNOWN GOAL TYPE!', 00H
	ORG $+1
$SG62333 DB	'invalid argument', 00H
	ORG $+3
$SG62334 DB	'%s', 00H
	ORG $+1
$SG62335 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\82102\Desktop\학교\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\goals\Raven_Goal_Types.cpp
_TEXT	SEGMENT
tv64 = -12						; size = 4
$T1 = -8						; size = 4
_this$ = -4						; size = 4
...
; Function compile flags: /Odtp /RTCsu
; File C:\Users\82102\Desktop\학교\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\goals\Raven_Goal_Types.h
