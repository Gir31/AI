; Listing generated by Microsoft (R) Optimizing Compiler Version 19.44.35221.0 
	...
	TITLE	C:\Users\82102\Desktop\학교\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\FuzzySet_Singleton.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG77759 DB	'invalid argument', 00H
	ORG $+3
$SG77760 DB	'%s', 00H
	ORG $+1
$SG77761 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
; File C:\Users\82102\Desktop\학교\AI\Source\VS2010\Common\fuzzy\FuzzySet_Singleton.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
_val$ = 8						; size = 8
