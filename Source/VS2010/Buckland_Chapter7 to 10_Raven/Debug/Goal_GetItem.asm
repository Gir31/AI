...
_BSS	ENDS
CONST	SEGMENT
$SG208625 DB	'Goal_GetItem cannot determine item type', 00H
$SG217635 DB	'invalid argument', 00H
	ORG $+3
$SG217636 DB	'%s', 00H
	ORG $+1
$SG217637 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
?_Valid_strftime_specifiers@std@@3QBDB DB 061H		; std::_Valid_strftime_specifiers
	...
	DB	07aH
	DB	05aH
$SG218282 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
