; Listing generated by Microsoft (R) Optimizing Compiler Version 19.42.34435.0 
	...
	TITLE	C:\Users\rpg26\OneDrive\Desktop\ÇÐ±³\AI\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\WindowUtils.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG165127 DB	'invalid argument', 00H
	ORG $+3
$SG165128 DB	'%s', 00H
	ORG $+1
$SG165129 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.42.34433\include\xmemory', 00H
	ORG $+6
$SG165130 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
...
$SG165131 DB	00H, 00H
	ORG $+2
$SG165132 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
?_Valid_strftime_specifiers@std@@3QBDB DB 061H		; std::_Valid_strftime_specifiers
	...
	DB	07aH
	DB	05aH
$SG160070 DB	'Error', 00H
	ORG $+2
$SG160074 DB	'Error', 00H
	ORG $+2
$SG160165 DB	'*.*', 00H
$SG160166 DB	'All Files (*.*)', 00H
$SG160167 DB	'*.', 00H
CONST	ENDS
...
$LN9@Allocate_m:
	push	OFFSET $SG165127
	push	OFFSET $SG165128
	push	0
	push	159					; 0000009fH
	push	OFFSET $SG165129
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	159					; 0000009fH
	push	OFFSET $SG165130
	push	OFFSET $SG165131
	push	OFFSET $SG165132
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\include\iosfwd
...
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\include\iomanip
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\include\sstream
...
tv69 = -37						; size = 1
__Newptr$ = -36						; size = 4
__Seekdist$ = -32					; size = 4
__Seeklow$ = -28					; size = 4
__Pptr_old$ = -24					; size = 4
__Gptr_old$ = -20					; size = 4
__Off$ = -16						; size = 8
__Need_write_but_cannot$ = -6				; size = 1
__Need_read_but_cannot$ = -5				; size = 1
_this$ = -4						; size = 4
...
$LN13@seekpos:
	...
	mov	BYTE PTR __Need_read_but_cannot$[ebp], al
...
$LN15@seekpos:
	...
	mov	BYTE PTR __Need_write_but_cannot$[ebp], cl

; 463  :         if (_Need_read_but_cannot || _Need_write_but_cannot) {

	movzx	edx, BYTE PTR __Need_read_but_cannot$[ebp]
	test	edx, edx
	jne	SHORT $LN3@seekpos
	movzx	eax, BYTE PTR __Need_write_but_cannot$[ebp]
	test	eax, eax
...
; 471  :         if (_Pptr_old && _Seekhigh < _Pptr_old) { // update high-water pointer
	...
	cmp	edx, DWORD PTR __Pptr_old$[ebp]
...
; 476  :         const auto _Seekdist = _Seekhigh - _Seeklow;
	...
	mov	DWORD PTR __Seekdist$[ebp], eax
...
; 477  :         if (static_cast<unsigned long long>(_Off) > static_cast<unsigned long long>(_Seekdist)) {
	...
	cmp	ecx, DWORD PTR tv224[ebp+4]
	jb	SHORT $LN5@seekpos
	ja	SHORT $LN18@seekpos
	mov	edx, DWORD PTR __Off$[ebp]
	cmp	edx, DWORD PTR tv224[ebp]
...
__Both$1 = -36						; size = 4
__Newoff$ = -32						; size = 8
__Seekdist$ = -24					; size = 4
__Seeklow$ = -20					; size = 4
__Pptr_old$ = -16					; size = 4
__Gptr_old$ = -12					; size = 4
__Need_write_but_cannot$ = -6				; size = 1
__Need_read_but_cannot$ = -5				; size = 1
_this$ = -4						; size = 4
___$ReturnUdt$ = 8					; size = 4
...
; 439  :         if (static_cast<unsigned long long>(_Off) + _Newoff > static_cast<unsigned long long>(_Seekdist)) {
	...
	mov	edx, DWORD PTR tv273[ebp+4]
	cmp	edx, DWORD PTR tv276[ebp+4]
	jb	SHORT $LN18@seekoff
	ja	SHORT $LN31@seekoff
...
; 328  :         const auto _Newptr = _Unfancy(_Allocate_at_least_helper(_Al, _Newsize));
	...
	lea	edx, DWORD PTR __Newsize$[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
...
; 342  :             _Al.deallocate(_Ptr_traits::pointer_to(*_Oldptr), _Oldsize);
	...
	push	edx
	mov	eax, DWORD PTR __Oldptr$[ebp]
	push	eax
	call	?pointer_to@?$pointer_traits@PAD@std@@SAPADAAD@Z ; std::pointer_traits<char *>::pointer_to
	add	esp, 4
	push	eax
...
; 348  :     }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN18@overflow
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
...
; 201  :             _Result._Size    = static_cast<_Mysize_type>((_STD max)(_Mysb::pptr(), _Seekhigh) - _Base);
	...
	add	esp, 8
	mov	edx, DWORD PTR [eax]
	sub	edx, DWORD PTR __Base$3[ebp]
...
; 203  :         } else if (!(_Mystate & _Noread) && _Mysb::gptr()) {
	...
	mov	ecx, DWORD PTR [eax+60]
	and	ecx, 4
	jne	SHORT $LN5@Get_buffer
	mov	ecx, DWORD PTR _this$[ebp]
	call	?gptr@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::gptr
	test	eax, eax
	je	SHORT $LN5@Get_buffer
...
; 205  :             const auto _Base = _Mysb::eback();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?eback@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::eback
	mov	DWORD PTR __Base$2[ebp], eax

; 206  :             _Result._Ptr     = _Base;

	mov	edx, DWORD PTR __Base$2[ebp]
	mov	DWORD PTR __Result$[ebp], edx
...
; 207  :             _Result._Size    = static_cast<_Mysize_type>(_Mysb::egptr() - _Base);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?egptr@?$basic_streambuf@DU?$char_traits@D@std@@@std@@IBEPADXZ ; std::basic_streambuf<char,std::char_traits<char> >::egptr
	sub	eax, DWORD PTR __Base$2[ebp]
	mov	DWORD PTR __Result$[ebp+4], eax
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\include\streambuf
...
; 341  :                 if (_Count < _Size) {
	...
	cmp	edx, DWORD PTR __Size$1[ebp+4]
	jg	SHORT $LN6@xsputn
...
; 312  :                 if (_Count < _Size) {
	...
	mov	edx, DWORD PTR __Count$[ebp+4]
	cmp	edx, DWORD PTR __Size$2[ebp+4]
	jg	SHORT $LN6@xsgetn
...
; 313  :                     _Size = _Count;
	...
	mov	ecx, DWORD PTR __Count$[ebp]
	mov	edx, DWORD PTR __Count$[ebp+4]
	mov	DWORD PTR __Size$2[ebp], ecx
	mov	DWORD PTR __Size$2[ebp+4], edx
$LN6@xsgetn:
...
; 317  :                 _Ptr += _Size;
	...
	mov	edx, DWORD PTR __Size$2[ebp]
	add	edx, DWORD PTR __Ptr$[ebp]
	mov	DWORD PTR __Ptr$[ebp], edx
...
; 322  :                 if (_Traits::eq_int_type(_Traits::eof(), _Meta)) {
	...
	mov	ecx, DWORD PTR __Meta$1[ebp]
	push	ecx
	call	?eof@?$_Narrow_char_traits@DH@std@@SAHXZ ; std::_Narrow_char_traits<char,int>::eof
	push	eax
	call	?eq_int_type@?$_Narrow_char_traits@DH@std@@SA_NHH@Z ; std::_Narrow_char_traits<char,int>::eq_int_type
...
; 327  :                 *_Ptr++ = _Traits::to_char_type(_Meta);
	...
	mov	eax, DWORD PTR __Meta$1[ebp]
	push	eax
	call	?to_char_type@?$_Narrow_char_traits@DH@std@@SADH@Z ; std::_Narrow_char_traits<char,int>::to_char_type
	add	esp, 4
	mov	ecx, DWORD PTR __Ptr$[ebp]
...
; 206  :     basic_ostream& __CLR_OR_THIS_CALL operator<<(ios_base&(__cdecl* _Pfn)(ios_base&) ) {
...
; 67   :     __CLR_OR_THIS_CALL ~basic_ostream() noexcept override {}
...
; 36   :     explicit __CLR_OR_THIS_CALL basic_ostream(basic_streambuf<_Elem, _Traits>* _Strbuf, bool _Isstd = false) {
...
; 3189 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, const basic_string<_Elem, _Traits, _Alloc>& _Right) {
...
; 3190 :     return _STD move(_Left.append(_Right));
...
; 3220 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, _In_z_ const _Elem* const _Right) {
...
; 3221 :     return _STD move(_Left.append(_Right));
...
; 3226 :     basic_string<_Elem, _Traits, _Alloc>&& _Left, const _Elem _Right) {
...
; 3172 :     const basic_string<_Elem, _Traits, _Alloc>& _Left, const _Elem _Right) {
...
; 3173 :     const auto _Left_size = _Left.size();

	mov	ecx, DWORD PTR __Left$[ebp]
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	mov	DWORD PTR __Left_size$[ebp], eax

; 3174 :     if (_Left_size == _Left.max_size()) {
...
; 3176 :     }
; 3177 : 
; 3178 :     return {_String_constructor_concat_tag{}, _Left, _Left.c_str(), _Left_size, _STD addressof(_Right), 1};
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\ÇÐ±³\AI\AI\Source\VS2010\Common\misc\Stream_Utility_Functions.h
...
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\ÇÐ±³\AI\AI\Source\VS2010\Common\misc\WindowUtils.cpp
_TEXT	SEGMENT
$T1 = -42						; size = 1
$T2 = -41						; size = 1
_s$ = -36						; size = 28
...
; 199  : _EXPORT_STD inline ios_base& __CLRCALL_OR_CDECL fixed(ios_base& _Iosbase) { // set floatfield to fixed
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\include\xiosbase
...
; 254  :     fmtflags __CLR_OR_THIS_CALL setf(fmtflags _Newfmtflags, fmtflags _Mask) noexcept /* strengthened */ {
...
; 255  :         // merge in format flags argument under mask argument
; 256  :         const ios_base::fmtflags _Oldfmtflags = _Fmtfl;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	mov	DWORD PTR __Oldfmtflags$[ebp], ecx

; 257  :         _Fmtfl                                = (_Oldfmtflags & ~_Mask) | (_Newfmtflags & _Mask & _Fmtmask);
...
; 1300 : constexpr void _Adl_verify_range(const _Iter& _First, const _Sentinel& _Last) {

	push	ebp
	mov	ebp, esp
$LN4@Adl_verify:

; 1301 :     // check that [_First, _Last) forms an iterator range
; 1302 :     if constexpr (is_pointer_v<_Iter> && is_pointer_v<_Sentinel>) {
; 1303 : #if _ITERATOR_DEBUG_LEVEL != 0
; 1304 :         _STL_VERIFY(_First <= _Last, "transposed pointer range");

	mov	eax, DWORD PTR __First$[ebp]
	mov	ecx, DWORD PTR __Last$[ebp]
	mov	edx, DWORD PTR [eax]
	cmp	edx, DWORD PTR [ecx]
	ja	SHORT $LN8@Adl_verify
	jmp	SHORT $LN6@Adl_verify
$LN8@Adl_verify:
...
$LN11@Adl_verify:
	...
	add	esp, 20					; 00000014H
	xor	ecx, ecx
	jne	SHORT $LN8@Adl_verify
$LN6@Adl_verify:
	xor	edx, edx
	jne	SHORT $LN4@Adl_verify

; 1305 : #endif // _ITERATOR_DEBUG_LEVEL != 0
; 1306 :     } else if constexpr (_Range_verifiable_v<_Iter, _Sentinel>) {
; 1307 :         _Verify_range(_First, _Last);
; 1308 :     }
; 1309 : }
...
; 46   :     void __CLRCALL_OR_CDECL operator delete(void* _Ptr) noexcept { // replace operator delete
...
; 42   :     void* __CLRCALL_OR_CDECL operator new(size_t _Size, const nothrow_t&) noexcept { // replace nothrow operator new
...
; 43   :         return _malloc_dbg(_Size > 0 ? _Size : 1, _CRT_BLOCK, __FILE__, __LINE__);
...
$LN4@operator:
	push	43					; 0000002bH
	push	OFFSET ??_C@_0GC@LEHJKL@C?3?2Program?5Files?2Microsoft?5Visu@
	push	2
...
; 33   :     void* __CLRCALL_OR_CDECL operator new(size_t _Size) { // replace operator new
...
; 34   :         void* _Ptr = operator new(_Size, nothrow);
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\include\xlocinfo
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\include\xfacet
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\include\system_error
...
; 2487 : _NODISCARD constexpr _To _Bit_cast(const _From& _Val) noexcept {

	push	ebp
	mov	ebp, esp
	push	ecx

; 2488 :     return __builtin_bit_cast(_To, _Val);
...
; 108  :   std::string filter = defaultFileTypeDescription + '\0' + "*." + defaultFileExtension + '\0' +
	...
	push	0
	push	0
	push	OFFSET $SG160165
	push	0
	push	OFFSET $SG160166
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG160167
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
...
; 2244 :     _NODISCARD _CONSTEXPR20 reference at(const size_type _Off) {
...
; 2245 :         _Mypair._Myval2._Check_offset_exclusive(_Off);
...
; 2246 :         return _Mypair._Myval2._Myptr()[_Off];
...
; 452  :     _NODISCARD static constexpr int_type not_eof(const int_type _Meta) noexcept {
...
; 453  :         return _Meta != eof() ? _Meta : !eof();

	call	?eof@?$_Narrow_char_traits@DH@std@@SAHXZ ; std::_Narrow_char_traits<char,int>::eof
	cmp	DWORD PTR __Meta$[ebp], eax
...
; 444  :     _NODISCARD static constexpr int_type to_int_type(const _Elem _Ch) noexcept {

	push	ebp
	mov	ebp, esp

; 445  :         return static_cast<unsigned char>(_Ch);
...
; 432  :     _NODISCARD static constexpr bool eq(const _Elem _Left, const _Elem _Right) noexcept {
...
; 433  :         return _Left == _Right;
	...
	movsx	eax, BYTE PTR __Left$[ebp]
	movsx	ecx, BYTE PTR __Right$[ebp]
	cmp	eax, ecx
	jne	SHORT $LN3@eq
	mov	DWORD PTR tv67[ebp], 1
	jmp	SHORT $LN4@eq
