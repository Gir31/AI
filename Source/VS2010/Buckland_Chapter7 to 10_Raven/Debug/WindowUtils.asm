; Listing generated by Microsoft (R) Optimizing Compiler Version 19.44.35221.0 
	...
	TITLE	C:\Users\82102\Desktop\ÇÐ±³\AI\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\WindowUtils.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG198941 DB	'invalid argument', 00H
	ORG $+3
$SG198942 DB	'%s', 00H
	ORG $+1
$SG198943 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
...
?_Valid_strftime_specifiers@std@@3QBDB DB 061H		; std::_Valid_strftime_specifiers
	...
	DB	07aH
	DB	05aH
$SG194055 DB	'Error', 00H
	ORG $+2
$SG194059 DB	'Error', 00H
	ORG $+2
$SG194150 DB	'*.*', 00H
$SG194151 DB	'All Files (*.*)', 00H
$SG194152 DB	'*.', 00H
CONST	ENDS
...
; Function compile flags: /Odtp /RTCsu
; File C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.44.35207\include\iomanip
...
; 200  :     basic_ostream& __CLR_OR_THIS_CALL operator<<(ios_base&(__cdecl* _Pfn)(ios_base&) ) {
...
; 3197 :     const basic_string<_Elem, _Traits, _Alloc>& _Left, const _Elem _Right) {
...
; 3198 :     const auto _Left_size = _Left.size();

	mov	ecx, DWORD PTR __Left$[ebp]
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	mov	DWORD PTR __Left_size$[ebp], eax

; 3199 :     if (_Left_size == _Left.max_size()) {
...
; 3201 :     }
; 3202 : 
; 3203 :     return {_String_constructor_concat_tag{}, _Left, _Left.c_str(), _Left_size, _STD addressof(_Right), 1};
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\82102\Desktop\ÇÐ±³\AI\Source\VS2010\Common\misc\Stream_Utility_Functions.h
...
; Function compile flags: /Odtp /RTCsu
; File C:\Users\82102\Desktop\ÇÐ±³\AI\Source\VS2010\Common\misc\WindowUtils.cpp
_TEXT	SEGMENT
$T1 = -42						; size = 1
$T2 = -41						; size = 1
_s$ = -36						; size = 28
...
; 2754 :     _Elem __CLR_OR_THIS_CALL widen(char _Byte) const { // widen char
...
; 108  :   std::string filter = defaultFileTypeDescription + '\0' + "*." + defaultFileExtension + '\0' +
	...
	push	0
	push	0
	push	OFFSET $SG194150
	push	0
	push	OFFSET $SG194151
	push	0
	mov	eax, DWORD PTR _defaultFileExtension$[ebp]
	push	eax
	push	OFFSET $SG194152
	push	0
	mov	ecx, DWORD PTR _defaultFileTypeDescription$[ebp]
	push	ecx
...
; 2369 :     _NODISCARD _CONSTEXPR20 size_type length() const noexcept {
...
; 2257 :     _NODISCARD _CONSTEXPR20 reference at(const size_type _Off) {
...
; 2258 :         _Mypair._Myval2._Check_offset_exclusive(_Off);
...
; 2259 :         return _Mypair._Myval2._Myptr()[_Off];
...
; 1622 :             _Traits::move(_Old_ptr, _Ptr, _Count);
...
; 712  :     _CONSTEXPR20 explicit basic_string(const _Alloc& _Al) noexcept : _Mypair(_One_then_variadic_args_t{}, _Al) {
...
; 525  :     _NODISCARD static constexpr int_type not_eof(const int_type _Meta) noexcept {
...
; 505  :     _NODISCARD static constexpr bool eq(const _Elem _Left, const _Elem _Right) noexcept {

	push	ebp
	mov	ebp, esp
	push	ecx

; 506  :         return _Left == _Right;
