; Listing generated by Microsoft (R) Optimizing Compiler Version 19.42.34435.0 
	...
	TITLE	C:\Users\rpg26\OneDrive\Desktop\Source\VS2010\Buckland_Chapter7 to 10_Raven\Debug\Raven_TargetingSystem.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?_Valid_strftime_specifiers@std@@3QBDB DB 061H		; std::_Valid_strftime_specifiers
	...
	DB	07aH
	DB	05aH
$SG171150 DB	'invalid argument', 00H
	ORG $+3
$SG171151 DB	'%s', 00H
	ORG $+5
$SG171152 DB	'C:\Program Files\Microsoft Visual Studio\2022\Community\'
	DB	'VC\Tools\MSVC\14.42.34433\include\xmemory', 00H
	ORG $+6
$SG171153 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
...
$SG171154 DB	00H, 00H
	ORG $+2
$SG171155 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
...
$LN9@Allocate_m:
	push	OFFSET $SG171150
	push	OFFSET $SG171151
	push	0
	push	159					; 0000009fH
	push	OFFSET $SG171152
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	159					; 0000009fH
	push	OFFSET $SG171153
	push	OFFSET $SG171154
	push	OFFSET $SG171155
...
; 920  :         _Choose_pocma_v<_Alnode> == _Pocma_values::_Equal_allocators) /* strengthened */ {
...
; 921  :         if (this == _STD addressof(_Right)) {
...
; 926  :         auto& _Right_al           = _Right._Getal();

	mov	ecx, DWORD PTR __Right$[ebp]
	call	?_Getal@?$list@PAVRaven_Bot@@V?$allocator@PAVRaven_Bot@@@std@@@std@@AAEAAV?$allocator@U?$_List_node@PAVRaven_Bot@@PAX@std@@@2@XZ ; std::list<Raven_Bot *,std::allocator<Raven_Bot *> >::_Getal
	mov	DWORD PTR __Right_al$[ebp], eax

; 927  :         constexpr auto _Pocma_val = _Choose_pocma_v<_Alnode>;

	mov	DWORD PTR __Pocma_val$[ebp], 0

; 928  :         if constexpr (_Pocma_val == _Pocma_values::_Propagate_allocators) {
; 929  :             if (_Al != _Right_al) {
; 930  :                 auto&& _Alproxy       = _GET_PROXY_ALLOCATOR(_Alnode, _Al);
; 931  :                 auto&& _Right_alproxy = _GET_PROXY_ALLOCATOR(_Alnode, _Right_al);
; 932  :                 _Container_proxy_ptr<_Alty> _Proxy(_Right_alproxy, _Leave_proxy_unbound{});
; 933  :                 auto& _My_data      = _Mypair._Myval2;
; 934  :                 auto& _Right_data   = _Right._Mypair._Myval2;
; 935  :                 const auto _Newhead = _STD exchange(_Right_data._Myhead, _Node::_Buyheadnode(_Right_al));
; 936  :                 const auto _Newsize = _STD exchange(_Right_data._Mysize, size_type{0});
; 937  :                 _Tidy();
; 938  :                 _Pocma(_Al, _Right_al);
; 939  :                 _My_data._Myhead = _Newhead;
; 940  :                 _My_data._Mysize = _Newsize;
; 941  :                 _Proxy._Bind(_Alproxy, _STD addressof(_My_data));
; 942  :                 _My_data._Swap_proxy_and_iterators(_Right_data);
; 943  :                 return *this;
; 944  :             }
; 945  :         } else if constexpr (_Pocma_val == _Pocma_values::_No_propagate_allocators) {
; 946  :             if (_Al != _Right_al) {
; 947  :                 assign(_STD make_move_iterator(_Right._Unchecked_begin()),
; 948  :                     _STD make_move_iterator(_Right._Unchecked_end()));
; 949  :                 return *this;
; 950  :             }
; 951  :         }
; 952  : 
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File C:\Users\rpg26\OneDrive\Desktop\Source\VS2010\Buckland_Chapter7 to 10_Raven\Raven_TargetingSystem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
